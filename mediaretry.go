...
//	if errors.Is(err, whatsgo.ErrMediaDownloadFailedWith404) || errors.Is(err, whatsgo.ErrMediaDownloadFailedWith410) {
...
//	    retryData, err := whatsgo.DecryptMediaRetryNotification(evt, imageMsg.GetMediaKey())
