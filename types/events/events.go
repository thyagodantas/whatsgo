...
// Package events contains all the events that whatsgo.Client emits to functions registered with AddEventHandler.
package events
...
import (
	...
	armadillo "github.com/thyagodantas/whatsgo/proto"
